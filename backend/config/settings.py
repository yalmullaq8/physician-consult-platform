...
SESSION_COOKIE_SAMESITE = os.getenv("SESSION_COOKIE_SAMESITE", _COOKIE_SAMESITE_DEFAULT)
CSRF_COOKIE_SAMESITE = os.getenv("CSRF_COOKIE_SAMESITE", _COOKIE_SAMESITE_DEFAULT)
